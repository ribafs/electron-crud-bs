    ...
    getConfig() {
        return {
            ...
            fields: {
                ...
                "vat": {label: "Lucro", type: "select", options: ["7%", "19%"], onChange: this.changeVat.bind(this)},
                "quantity": {label: "Quantidade", type: "integer"},
                "price_net": {label: "Preço líquido", type: "currency", onChange: this.changePriceNet.bind(this)},
                "price_gross": {label: "Preço bruto", type: "currency", onChange: this.changePriceGross.bind(this)},
            },
