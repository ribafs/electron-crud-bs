...
module.exports = class Crud extends (require("./Component")) {
    ...
    render() {
        return "<h1>Produtos</h1>" + this.renderToolbar() + this.renderTable()
    }

    renderToolbar() {
        return '<div class="mb-2"><button type="button" class="btn btn-light btn-add"><i class="fa fa-plus"></i> Adicionar</button></div>'
    }
